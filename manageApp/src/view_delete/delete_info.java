...
public class delete_info extends JDialog{
	
	private JButton yesButton,noButton;
	private JTextField show_name,show_Tel,show_Email;
	private static Person person;
	public delete_info(String name,JFrame frame,Person person) {
		...
		titleBox.add(new JLabel("删除信息：",JLabel.LEFT));
		...
		yesButton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				PersonDao.delete(delete_info.person);
				new delete_success();
