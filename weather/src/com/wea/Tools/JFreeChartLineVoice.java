...
@SuppressWarnings("unused")
 public class JFreeChartLineVoice {
	...
	private static CategoryDataset getCategoryDataset(Map<java.sql.Date, Float> map)
	{
		...
		CategoryDataset dataset=DatasetUtilities.createCategoryDataset("声环境质量", keyedValues);	
		return dataset;
	...
	public  static void main(String []args)
	{
		...
		Map<java.sql.Date, Float> map = DataDao.getPreAvgMap(date, 7, 2);
		CategoryDataset dataset=getCategoryDataset(map);				JFreeChart chart=ChartFactory.createLineChart("声环境质量", "天", "sound", dataset,PlotOrientation.VERTICAL,true,false,false);
	...
	//valueAxis.setLabelFont(new Font("宋体",Font.PLAIN,14));
		...
		try{
			fos_jpg1=new FileOutputStream("../weather/WebRoot/images/噪音折线图.jpg");
