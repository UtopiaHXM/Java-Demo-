...
.more {
  ...
  <body>
    ...
    <br>
    <br><p align="left">
    <img alt="" src="images/button.gif"></p>
    <br>
    <br>
    <br>
    <br>
      ...
      <fieldset>
        <legend class="Allfont">欢迎管理员》添加新闻</legend>
<table width="700" border="0" cellpadding="5" cellspacing="1" class="table">
  <tbody>
       <th width=200 ><center><b>新闻标题:</b></center></th>
       <td  class="td" align="left"><input  type="text" name="politicalTitle" size="62"></td>
       </tr>
       <tr>
       <th width=500 ><center><b>新闻内容</b></center></th>
       <td class="td" width=500 ><textarea rows="5" cols="55" name="politicalContent"></textarea></td>
       </tr>
       <tr>
