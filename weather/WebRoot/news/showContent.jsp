...
.more {
  ...
  <body>
  <br>
 <font color="red">当前位置>><script type="text/javascript">
    <!--
...
<br>
      ...
      <fieldset>
        <legend class="Allfont">新闻修改</legend>
<table width="700" border="0" cellpadding="5" cellspacing="1" class="table">
  <tbody>
    ...
    <input type="text" name="id" value=<%=id%>>
       ...
       <tr>
       <th  ><center><b>当前标题:</b></center></th>
        <td class="td" width=500> 
    <input type="text" name="title" value=<%=title%>>
      </td>
       </tr>
       <tr>
       <th ><center><b>内容</b></center></th>
        <td class="td" > <textarea rows="20" cols="55" name="content" ><%=content%></textarea></td>
       </tr>
       <tr>
        <td class="td"colspan=2><center><input type="submit" value="确认">
       <input type="button" value="返回" onclick="javascript:history.back();"></center></td>
       </tr></tbody>
     </table>    </fieldset>  
    </form>
    <%
