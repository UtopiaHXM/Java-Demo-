...
<html>
  <head>
    ...
    <title>My JSP 'areaIndex.jsp' starting page</title>
...
.more {
  ...
  String address = request.getParameter("address"); 
   %>
   <%
   if( address.equals("east")){
   add="哈尔滨理工大学东区";
   }
   else if( address.equals("west") ){
   add="哈尔滨理工大学南区";
   }else if( address.equals("south")){
   add="哈尔滨理工大学西区";
   }
...
<th height="80" colspan="2" >
 <p><b><font size=5 ">选择要上传文件</font></b></p> <font color="#FF3300" size="+3"></font></td></tr>

<tr><td class="td" height="120" >
        <FORM METHOD="POST" ACTION="back/areaback/uploadfile2.jsp" ENCTYPE="multipart/form-data">
             <center><INPUT TYPE="FILE" NAME="FILE1" SIZE="50"></center><BR>
             <br>
           <center>  <INPUT TYPE="SUBMIT" VALUE="开始上传"></center>
        </FORM>
</td>
</tr></tbody>
</table></fieldset>
